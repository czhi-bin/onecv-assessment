...
func CreateRegistration(teacherEmail, studentEmail string) error {
	...
	teacherID, err := getTeacherIDByEmail(teacherEmail)
	if err != nil {
	...
	studentID, err := getStudentIDByEmail(studentEmail)
	if err != nil {
	...
	registration := model.Registration{TeacherID: teacherID, StudentID: studentID}
	err = createRegistration(&registration)
	if err != nil {
